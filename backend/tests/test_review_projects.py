...
def test_create_review_project_requires_merge_mode(authed_client):
    response = authed_client.post("/review-projects", json={"name": "My Review"})
...
def test_list_review_projects(authed_client):
    authed_client.post("/review-projects", json={"name": "First", "merge_mode": "combine"})
    authed_client.post(
...
def test_list_review_projects_only_returns_own_projects(client):
    ...
    client.post(
        "/review-projects",
        json={"name": "Owner's Review", "merge_mode": "combine"},
        headers=owner_headers,
    )
    client.post(
        "/review-projects",
        json={"name": "Other's Review", "merge_mode": "combine"},
